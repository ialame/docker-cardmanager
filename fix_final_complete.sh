...
echo "🔧 SOLUTION FINALE : PARENT CARDMANAGER → MASON → PAINTER"
echo "========================================================="
...
print_step "2. Création du Dockerfile FINAL avec parent CardManager"
cat > docker/painter/Dockerfile << 'EOF'
# =============================================================================
# Dockerfile Painter - SOLUTION FINALE COMPLÈTE
# =============================================================================
...
# Si le build original échoue, créer un POM autonome
...
print_success "Dockerfile FINAL créé avec ordre correct : CardManager → Mason → Painter"
